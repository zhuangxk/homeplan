...
Page({
    data: {
        ...
        billTypes: [{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'},{name: '购物',icon: 'check'}],
        TabCur: 0,
        MainCur: 0,
        VerticalNavTop: 0,
        list: [],
