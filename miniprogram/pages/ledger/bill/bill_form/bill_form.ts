...
Page({
    data: {
        ...
        billTypeChilden: [
          { parentId: 0, name: '蒜苔', icon: 'appreciate' },
          { parentId: 0, name: '蒜苔', icon: 'appreciate' },
          { parentId: 0, name: '蒜苔', icon: 'appreciate' },
          { parentId: 1, name: '蒜苔', icon: 'appreciate' },
          { parentId: 1, name: '蒜苔', icon: 'appreciate' },
          { parentId: 1, name: '蒜苔', icon: 'appreciate' },
          { parentId: 1, name: '蒜苔', icon: 'appreciate' },
          { parentId: 2, name: '蒜苔', icon: 'appreciate' },
          { parentId: 2, name: '蒜苔', icon: 'appreciate' },
          { parentId: 2, name: '蒜苔', icon: 'appreciate' },
          { parentId: 2, name: '蒜苔', icon: 'appreciate' },
          { parentId: 3, name: '蒜苔', icon: 'appreciate' },
          { parentId: 3, name: '蒜苔', icon: 'appreciate' },
          { parentId: 3, name: '蒜苔', icon: 'appreciate' },
          { parentId: 4, name: '蒜苔', icon: 'appreciate' },
          { parentId: 5, name: '蒜苔', icon: 'appreciate' },
          { parentId: 6, name: '蒜苔', icon: 'appreciate' },
          { parentId: 7, name: '蒜苔', icon: 'appreciate' },
          { parentId: 8, name: '蒜苔', icon: 'appreciate' },
          { parentId: 10, name: '蒜苔', icon: 'appreciate' },
          { parentId: 11, name: '蒜苔', icon: 'appreciate' },
          { parentId: 11, name: '蒜苔', icon: 'appreciate' },
          { parentId: 13, name: '蒜苔', icon: 'appreciate' },
          { parentId: 14, name: '蒜苔', icon: 'appreciate' },
          { parentId: 15, name: '蒜苔', icon: 'appreciate' }
        ],
        TabCur: 0,
        MainCur: 0,
        VerticalNavTop: 0,
